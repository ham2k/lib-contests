...
const { useBuiltinCountryFile } = require('@ham2k/lib-country-files/builtinData')

useBuiltinCountryFile()

/* eslint-disable new-cap */
/* Our `findContestInfoForId` method is not a costructor name per se, but returns a constructor. */
